...
import com.symphonyteleca.lrn.catalyst.download.activities.MainActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		final Notification notification = new Notification(R.drawable.ic_launcher, tickerText,
		 ...
		 intents .setAction("android.intent.action.MAIN");
		 intents .addCategory("android.intent.category.LAUNCHER"); 
		final PendingIntent contentIntent = PendingIntent.getActivity(context, 0, intents, 0);
